            ...
            <div class="row">
                ...
                <div class="col-md-8 p-4 " style="background-color: lightblue; margin-top: 20px;">
                    ...
                    <span class="text font-weight-bold">logistics</span><span><?php echo "  ".$logistics;?></span></br>
                        ...
                        <span class="text font-weight-bold"><?php if ( is_null($status['Delivered'])){ }  else{echo "Shipped  :" .$status['Shipped'];}?>   </span>             </br>
                        ...
                        <span class="text font-weight-bold"><?php if ( is_null($status['Delivered'])){ }  else{echo "Out_for_delivery  :" .$status['Out_for_delivery'];}?>   </span>             </br>
