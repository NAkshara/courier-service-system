<?php 
    ...
    if(isset($_POST['sel_order'])){
        ...
        if(mysqli_num_rows($result)){
            ...
            // $status['place']=$del_status['currplace'];
    ...
    if(isset($_POST['update'])){
        ...
        $place=$_POST['currplace'];
        // echo $place;
        //echo 'value : '.$checked;
        $inp_tid = $_SESSION['up_tid'];
        $query="UPDATE status SET currplace='$place' WHERE TrackingID='$inp_tid'";
...
<html>
    ...
    <body style="font-family: Tahoma, sans-serif;background-image:url('SEImages/4img.png') ">
            ...
            <div class="row">
                <div class="col-2 dropdown">
                    ...
                    <ul class="dropdown-menu text-center" id="dd-menu">
                        ...
                        <li><div><a href="staff.php" style="color: black; text-decoration: none;">Logout</a></div></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active pt-3" id="ins" role="tabpanel" aria-labelledby="ins-tab">
                    <div class="container">
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form" method="POST">
                            ...
                            <div class="col-md-6 p-3" style="background-color: lightblue;">
                ...
                <div class="tab-pane fade" id="update" role="tabpanel" aria-labelledby="update-tab">
                    <div class="container mt-10">
                        <div class="row">
                            <div class="col-4 p-4 text-center pt-0" style="background-color: lightblue; margin-top: 20px;">
                            ...
                            <div class="col-8 p-4 " style="background-color: rgba(255, 255, 255, 0.7); margin-top: 20px; ">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="form">
                                    ...
                                    <div class="form-group">
                                        <input type='text'  name="currplace" >
                                        <label>place </label>
